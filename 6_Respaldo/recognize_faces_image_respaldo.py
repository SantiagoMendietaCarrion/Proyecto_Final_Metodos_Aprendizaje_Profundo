...
"""
example_images = [
    "/content/Proyecto_Final_Metodos_Aprendizaje_Profundo/Fotos_Testeo/Santiago_Testeo_1.jpg",
    "/content/Proyecto_Final_Metodos_Aprendizaje_Profundo/Fotos_Testeo/Santiago_Testeo_2.jpg",
    "/content/Proyecto_Final_Metodos_Aprendizaje_Profundo/Fotos_Testeo/Familia_Testeo_2.jpg",
]

ap = argparse.ArgumentParser()
ap.add_argument("-i", "--image", required=False,
                default=example_images[2],
